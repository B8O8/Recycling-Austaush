...
export default function aboutUs() {
    ...
    <div className='bg-beige mx-auto h-screen'>
        ...
        <div className='font-mysans'>
            <p>My name is <u>ChARBEL MAKHLOUF</u> I'm an it student at Arab Open University 
            I did this project for hellping people to solve one of the problems in lebanon</p>
        </div>
